...
-- DROP VIEW IF EXISTS V_Themenliste;
-- CREATE VIEW V_Themenliste
-- AS SELECT htmlid as id, 
--           parent, 
--           thematext as text, 
--           concat('{ "uniqueid" : "', id, '" }') as li_attr 
-- FROM T_Themen order by li_attr;
-- CREATE VIEW V_Themenliste2
-- AS SELECT htmlid as id, 
--           parent, 
--           thematext as text, 
--           concat("{ uniqueid : ", id, " }") as li_attr 
-- FROM T_Themen order by li_attr;
-- CREATE VIEW V_Themenliste3
-- AS SELECT id,
--           htmlid, 
--           parent, 
--           thematext
-- FROM T_Themen order by htmlid;
