...
<div id="seite">
	...
	<section id="sx_Mitte">
		<section id="sx_Themensection">
			...
			<div id="a_Themenliste">
				...
				<div id="ScrollWrapperThemen" class="ScrollMe"> 
		...
		<section id="sx_Aufgabensection">
				...
				<div id="AufgabeUndKonfiguration">
					<article id="a_Aufgabe_KonfUndMeta" class="ShowMedium ShowLarge">
						<fieldset>
							...
							<div class="halfspace">
								<input type="radio" id="r_Spiel" 			name="Spielinteraktion"	value="Spiel">							<label for="r_Spiel">Ohne Bewertungshinweise</label><br>
								<input type="radio" id="r_Hinweise"		name="Spielinteraktion"	value="Hinweise">						<label for="r_Hinweise">Mit Bewertungshinweisen</label>
							</div>
							<div class="halfspace">
								<input type="radio" id="r_Varianten"	name="Spielinteraktion"	value="Varianten" checked>	<label for="r_Varianten">Variantenanalyse</label><br>
								<input type="radio" id="r_lichess"		name="Spielinteraktion"	value="Lichess">						<label for="r_lichess">Lichess.org</label>
							</div>
						</fieldset>
					</article>
				</div>
			<div id="a_Aufgabenliste">
				<div id="AufgabenlisteTree">
					...
					<button id="btn_Aufgabeauswahl" type="button" onclick="Aufgabeauswahl()" class="KomfortButton">Alle Aufgaben anzeigen</button>
				</div>
			...
			<div>
			<label for="PGNTextSpiel"												>PGN:</label>				<textarea													name="PGNText"		id = "PGNTextSpiel"			disabled>	</textarea>
			</div>
		</section>
    ...
    <footer>
		...
		<article id="ModaleFenster">
			...
			<div id="dialog_DBErrorMessages"			class="hiddendialog">
			</div>
		</article>
